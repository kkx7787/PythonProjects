import sys
from lib.avg_trader import AvgTrader
...
if __name__ == '__main__':
    ...
    for price_info in get_price_list('1d'):
        ...
        # BUY
        if trader.buy_or_sell(price_list) == 'buy':  # TODO: --> if trader.buy_or_sell() == 'buy':
        ...
        # SELL
        if trader.buy_or_sell(price_list) == 'sell':  # TODO: --> if trader.buy_or_sell() == 'sell':
